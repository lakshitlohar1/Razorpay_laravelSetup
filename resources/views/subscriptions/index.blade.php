...
<body>
    ...
    <main>
        <div class="container">
            ...
            @endif
            <form id="subscription-form" action="{{ route('subscriptions.update') }}" method="POST">
                @csrf
                <input type="hidden" name="old_tier" value="{{ $Subscription->tier }}">
                <div class="form-group">
                    ...
                    <select name="tier" id="tier" class="form-control" required>
                        ...
                        <option value="silver" @if($Subscription->switch === 'silver') disabled @endif>Silver</option>
                        <option value="gold" @if($Subscription->switch === 'gold') disabled @endif>Gold</option>
                        <option value="platinum" @if($Subscription->switch === 'platinum') disabled @endif>Platinum</option>
                    </select>
                </div>
    ...
    <script>
        $(document).ready(function() {
            const currentTier = '{{ $Subscription->tier }}'; // Get current tier from PHP
            ...
            $('#subscription-form').on('submit', function(e) {
                ...
                if (tiers.indexOf(selectedTier) > tiers.indexOf(currentTier)) {
                    ...
                    window.location.href = "{{ route('index') }}"; // Replace 'buy.plan' with the correct route name
                    }
                } else {
