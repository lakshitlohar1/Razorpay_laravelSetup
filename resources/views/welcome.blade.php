...
<head>
    ...
    <style>
        ...
        .active-btn {
            background: #ffffff;
            /* White for active button */
            color: #1e1e2f;
            /* Dark background color for active button text */
        }
        ...
        <div class="cards">
            <div class="card shadow">
                <ul>
                    ...
                    <li><a href="{{ route('login') }}" class="btn">More</button></a>
                </ul>
            </div>
            <div class="card active">
                <ul>
                    ...
                    <li><a href="{{ route('login') }}" class="btn active-btn">More</button></a>
                </ul>
            </div>
            <div class="card shadow">
                <ul>
                    <li class="pack">Platinum (Paid)</li>
                    <li id="master" class="price bottom-bar">9999.00 INR</li>
